...
delay:
;so add 1 to a memory address, each time it overflows add one to another memory adress
;each time that overflows add 1 to another adress. When that reaches a value
; end the subroutine
          staa #1
          ldaa $1000
          staa #1
